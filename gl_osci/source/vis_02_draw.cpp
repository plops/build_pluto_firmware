...
void draw_circle(float sx, float sy, float rad) {
  ...
  {
    auto arg = (8.771930e-3f);
    glVertex2f(((sx) + (((rad) * (sinf(((2) * (M_PI) * (arg))))))),
               ((sy) + (((rad) * (cosf(((2) * (M_PI) * (arg))))))));
  }
  {
    auto arg = (1.7543860e-2f);
    glVertex2f(((sx) + (((rad) * (sinf(((2) * (M_PI) * (arg))))))),
               ((sy) + (((rad) * (cosf(((2) * (M_PI) * (arg))))))));
  }
  {
    auto arg = (2.631579e-2f);
    glVertex2f(((sx) + (((rad) * (sinf(((2) * (M_PI) * (arg))))))),
               ((sy) + (((rad) * (cosf(((2) * (M_PI) * (arg))))))));
  }
  {
    auto arg = (3.508772e-2f);
    glVertex2f(((sx) + (((rad) * (sinf(((2) * (M_PI) * (arg))))))),
               ((sy) + (((rad) * (cosf(((2) * (M_PI) * (arg))))))));
  }
  {
    auto arg = (4.3859650e-2f);
    glVertex2f(((sx) + (((rad) * (sinf(((2) * (M_PI) * (arg))))))),
               ((sy) + (((rad) * (cosf(((2) * (M_PI) * (arg))))))));
  }
  {
    auto arg = (5.263158e-2f);
    glVertex2f(((sx) + (((rad) * (sinf(((2) * (M_PI) * (arg))))))),
               ((sy) + (((rad) * (cosf(((2) * (M_PI) * (arg))))))));
  }
  {
    auto arg = (6.140351e-2f);
    glVertex2f(((sx) + (((rad) * (sinf(((2) * (M_PI) * (arg))))))),
               ((sy) + (((rad) * (cosf(((2) * (M_PI) * (arg))))))));
  }
  {
    auto arg = (7.017544e-2f);
    glVertex2f(((sx) + (((rad) * (sinf(((2) * (M_PI) * (arg))))))),
               ((sy) + (((rad) * (cosf(((2) * (M_PI) * (arg))))))));
  }
  {
    auto arg = (7.894737e-2f);
    glVertex2f(((sx) + (((rad) * (sinf(((2) * (M_PI) * (arg))))))),
               ((sy) + (((rad) * (cosf(((2) * (M_PI) * (arg))))))));
  }
  {
    auto arg = (8.771930e-2f);
    glVertex2f(((sx) + (((rad) * (sinf(((2) * (M_PI) * (arg))))))),
               ((sy) + (((rad) * (cosf(((2) * (M_PI) * (arg))))))));
  }
  {
    auto arg = (9.649122e-2f);
    glVertex2f(((sx) + (((rad) * (sinf(((2) * (M_PI) * (arg))))))),
               ((sy) + (((rad) * (cosf(((2) * (M_PI) * (arg))))))));
  }
  {
